  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 max-w-lg mx-auto">
          ...
          <div className="text-center">
            ...
            {!isToday && (
              <Button
                ...
                size="sm"
                onClick={handleToday}
                className="text-xs text-primary-neon hover:text-primary mt-1"
              >
                Go to today
              </Button>
            )}
        ...
        <div className="mb-6">
          ...
          <div className="w-full bg-muted/30 rounded-full h-2">
            <div 
              ...
              style={{ width: `${(completedCount / CORE_HABITS.length) * 100}%` }}
            />
          </div>
        </div>
          ...
          {CORE_HABITS.map((habit) => {
            ...
            return (
              <HabitCard
                ...
                className={cn(
                  'transform transition-all duration-smooth',
                  completed && 'shadow-card-hover'
                )}
              />
            );
          })}
        ...
        {completedCount === CORE_HABITS.length && (
          <div className="mt-8 p-6 bg-gradient-success rounded-card text-center">
        ...
        {completedCount === 0 && isToday && (
          <div className="mt-8 p-6 bg-card/30 rounded-card text-center">
            <div className="text-4xl mb-3">💪</div>
            <h3 className="text-lg font-semibold mb-2">
              Ready to transform?
            </h3>
            <p className="text-sm text-muted-foreground">
              Start by checking off your first habit above. Every journey begins with a single step.
            </p>
          </div>
        )}
      </div>
