...
**Step 3 — You enable Lovable Cloud.** Disconnect the external Supabase and enable Lovable Cloud in project settings. This regenerates `.env` and the Supabase client. The app will briefly be up but empty — expected.
...
2. Be ready to flip the connection at Step 3 and sign up at Step 6.
